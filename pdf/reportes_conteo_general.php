<?php
  ...
  $options  = array( PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION);
	...
	$sql = "SELECT sum(Inventario.tipo) as total,Inventario.idAlmacen, Producto.idLinea, Linea.nombre as linea, Almacen.name, Inventario.idAlmacen  from Inventario
...
group by Producto.idLinea,Linea.nombre,Inventario.idAlmacen, Almacen.name, Inventario.idAlmacen 
having Almacen.name <> 'apartado'
order by Inventario.idAlmacen asc
	...
	class PDF Extends FPDF
	{
		...
		$pdf->Cell(200,5, 'Conteo de articulos por linea', 0, 1, 'C');
		...
		$pdf->Cell(50, 6, 'Sucursal', 1, 0, 'C', 1);
