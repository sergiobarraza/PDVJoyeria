...
<div id="printableArea" style="width: 4in; margin: 0; text-align: center;">
      ...
      <p style="padding:0; margin: 0;text-align: left;">Proceso: Entrega de Trabajo</p>
      <p style="padding:0; margin: 0;text-align: left;font-weight: bold;">Folio: <?php echo $folio; ?></p>
      <p style="padding:0; margin: 0;text-align: left;font-weight: bold;">Cliente: <?php echo $rowcliente["nombre"]." ".$rowcliente["apellido"]; ?></p>	
...
<!-- Bootstrap core JavaScript-->
    ...
    <script type="text/javascript">
		window.onload = function(){
	    	...
	    	location.href= "Trabajos/index.php?folio=<?php echo $folio; ?>";
	    	//window.close();
		}
	</script>
