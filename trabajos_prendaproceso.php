				            ...
				            <tbody>
					            	...
					            	<?php
					            		for ($i=0 ; $i < $rows ; $i++){
											...
											echo "<td style='padding: 0;'><input type='text' name='tiempo' value=' ".$row["tiempo_estimado"]."' style = 'border:0; background: transparent; margin: 0; width: 100%; height: 48px; display: block; text-align: center;'></td>";
											echo "<td style='padding: 0;'><input type='text' name='costo' value='".$row["costo"]."' style = 'border:0; background: transparent; margin: 0; width: 100%; height: 48px; display: block; text-align: center;'></td>";
